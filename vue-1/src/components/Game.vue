				...
				<v-col cols="6" md="6">
					<v-item>
						<v-card
							...
							@click="toggle"
						>
							<v-row justify="space-between" style="padding: 10px 30px 10px 30px" >
								...
								<table>
									...
									<tr>
										<td v-for="num in [4, 5, 6]" :key="num">
											<v-btn color="orange" elevation="15" @click="clickNum($event, num)" >
												{{ num }}
											</v-btn>
										</td>
										<td>
									...
									<tr>
										...
										<td></td>
										<td>
											<v-btn color="grey" elevation="2" @click="answer">
												=
											</v-btn>
										</td>
									</tr>
